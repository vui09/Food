...
// Modal
    ...
    for (let i = 0; i < slides.length; i++){
        ...
        dots.push(dot); // помещаем точку и в массив
    }
    ...
    next.addEventListener('click', () => {
        ...
        dots.forEach(dot => dot.style.opacity = '.5'); // у каждой точки устанавливаем прозрачность
    ...
    dots.forEach(dot => {
        dot.addEventListener('click', (e) => {
            ...
            slideIndex = slideTo; // индекс слайда равен slideTo
    ...
    */
    ...
    if (localStorage.getItem('sex')) { // если в localStorage есть уже значение
    ...
    function calcTotal() {
        if (!sex || !height || !weight || !age || !ratio) { // если значения не заполнены
    ...
    function getStaticInformation(selector, activeClass) {
        ...
        elements.forEach(elem => {
            elem.addEventListener('click', (e) => {
                if (e.target.getAttribute('data-ratio')) { // если data-ratio присутствует у объекта
                    ratio = +e.target.getAttribute('data-ratio'); // получаем атрибут data-ratio
                ...
                elements.forEach(elem => {
                    elem.classList.remove(activeClass); // убрать активный класс у всех элементов
                });
    
                e.target.classList.add(activeClass); // долбавить класс диву на который кликнули
    ...
    function getDynamicInformation(selector) {
        ...
        input.addEventListener('input', () => {
            if (input.value.match(/\D/g)) { // если нашли не число
